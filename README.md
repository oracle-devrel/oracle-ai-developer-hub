...
| oracle_langchain_example          | Build a RAG application using Oracle AI Database vector storage and LangChain | Oracle AI Database, langchain-oracledb, HuggingFace | [![Open Notebook](https://img.shields.io/badge/Open%20Notebook-orange?style=flat-square)](./notebooks/oracle_langchain_example.ipynb)          |
